...
const getContact = async (accessToken) => {
  ...
  try {
    ...
    const deal = await request.get('https://api.hubapi.com/crm/v3/objects/deals/10024587447?archived=false', {
      headers: headers
    });
...
const displayContactName = (res, contact) => {
  ...
  const { dealname, amount, closedate } = deal.properties;
  res.write('<p>Deal Name: $(dealname.value) Deal Value: $(amount.value) Deal Close Date: $(closedate.value)');
